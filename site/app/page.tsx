...
function GoldenCircle() {
  return (
    <svg viewBox="0 0 240 240" className="h-56 w-56 shrink-0" role="img" aria-label="Le Cercle d'Or">
      ...
      <text x="120" y="116" textAnchor="middle" className="fill-[#9f4e2d]" style={{ fontSize: 15, fontWeight: 600, fontFamily: "var(--font-serif)" }}>
        Pourquoi
      </text>
      <text x="120" y="134" textAnchor="middle" className="fill-[#9f4e2d]" style={{ fontSize: 9 }}>
        la mission
      </text>
      <text x="120" y="70" textAnchor="middle" className="fill-bois" style={{ fontSize: 12, fontWeight: 600, fontFamily: "var(--font-serif)" }}>
        Comment
      </text>
      <text x="120" y="26" textAnchor="middle" className="fill-muted" style={{ fontSize: 12, fontWeight: 600, fontFamily: "var(--font-serif)" }}>
        Quoi
      </text>
    </svg>
  );
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-5xl px-5 pb-12 pt-16 text-center sm:pt-20">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Link
                href="/crm"
                className="rounded-full bg-terracotta px-6 py-3 text-sm font-medium text-paper shadow-sm transition hover:bg-terracotta-dark hover:shadow-md"
              >
          ...
          <div className="flex flex-col items-center gap-8 rounded-3xl border border-border bg-sand/40 p-8 sm:flex-row sm:gap-12 sm:p-10">
            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <p className="mt-0.5 text-[15px] text-ink/90">
              ...
              <p className="border-t border-border pt-4 text-[13px] text-muted">
                Archétype de marque : <strong className="text-bois-dark">le Créateur</strong> — donner forme
                à une vision, créer de l'unique et du durable. Cette voix guide aussi le ton du copilote IA.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl px-5 py-14">
            <div className="grid items-center gap-10 sm:grid-cols-2">
              <div>
                ...
                <h2 className="mt-4 font-serif text-3xl font-semibold text-bois-dark">
                  Un savoir-faire d'exception… qui vend à l'instinct.
                </h2>
                <p className="mt-3 text-[14.5px] leading-relaxed text-ink/80">
                  Pas de CRM, des devis sur Excel, et des relances qui passent à la trappe. Le carnet
                  de commandes vit sur la réputation et le bouche-à-oreille — mais des projets chauds
                  s'échappent faute de suivi.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-5 py-16">
          ...
          <div className="mt-9 text-center">
            <Link
              href="/crm"
              className="inline-flex items-center gap-2 rounded-full bg-bois-dark px-6 py-3 text-sm font-medium text-paper transition hover:bg-bois"
            >
        ...
        {/* ───────── IA RESPONSABLE ───────── */}
        <section className="border-y border-border bg-bois-dark text-paper">
          <div className="mx-auto max-w-5xl px-5 py-14">
            <div className="text-center">
            ...
            <div className="mt-9 grid gap-5 sm:grid-cols-3">
              <div className="rounded-2xl border border-paper/15 bg-paper/5 p-5">
                ...
                <p className="mt-1 text-[13px] leading-relaxed text-paper/75">
                  De vrais appels à une IA française, hébergée dans l'UE. Repli automatique pour ne
              ...
              <div className="rounded-2xl border border-paper/15 bg-paper/5 p-5">
                ...
                <p className="mt-1 text-[13px] leading-relaxed text-paper/75">
                  Les données ne servent pas à entraîner les modèles. Minimisation et hébergement UE.
                </p>
              </div>
              <div className="rounded-2xl border border-paper/15 bg-paper/5 p-5">
                <div className="text-2xl">👤</div>
                ...
                <p className="mt-1 text-[13px] leading-relaxed text-paper/75">
                  L'IA propose, l'humain valide. Chaque relance reste relue et éditée avant l'envoi.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-5xl px-5 py-16">
          ...
          <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3">
            {[
              ...
              <div key={i} className="flex items-center gap-3 rounded-xl border border-border bg-paper px-4 py-3">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-sand text-[12px] font-semibold text-bois-dark">
                  {i + 1}
                </span>
          ...
          <div className="mt-9 text-center">
            <Link
              href="/rendu"
              className="inline-flex items-center gap-2 rounded-full border border-bois-dark px-6 py-3 text-sm font-medium text-bois-dark transition hover:bg-sand"
            >
