...
export const AI_USECASES = [
  ...
  { icon: "✍️", etape: "Conclure", titre: "Copilote de relance", irritant: "Relances chronophages, donc jamais faites.", cas: "Génère un email « dans le ton » de la marque, adapté à l'objection.", indicateur: "Délai de relance · nb de relances envoyées" },
